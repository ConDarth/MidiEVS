...
AudioEffectDelay         delayFX;         //xy=2099.5,1009.25
AudioEffectBitcrusher    bitcrusher;    //xy=2199,842
AudioEffectDigitalCombine combine1;       //xy=2260.25,935.5
AudioMixer4              mixerBitCrusher;        //xy=2394,814
AudioMixer4              mixerDigitalFX;        //xy=2423.75,894.25
AudioEffectFreeverb      freeverb;      //xy=2595.0000381469727,818.5833854675293
AudioMixer4              mixerFreeverb;         //xy=2761.0000381469727,791.1666984558105
...
AudioConnection          patchCord121(mixerAmp, bitcrusher);
AudioConnection          patchCord122(mixerAmp, 0, mixerBitCrusher, 0);
AudioConnection          patchCord123(delayFX, 0, digitalFX, 1);
AudioConnection          patchCord124(bitcrusher, 0, mixerBitCrusher, 1);
AudioConnection          patchCord125(digitalFX, 0, mixerDigitalFX, 1);
AudioConnection          patchCord126(mixerBitCrusher, freeverb);
AudioConnection          patchCord127(freeverb, 0, mixerFreeverb, 1);
AudioConnection          patchCord128(mixerFreeverb, 0, i2s1, 0);
AudioConnection          patchCord129(mixerFreeverb, 0, i2s1, 1);
...
void setup() {
  ...
  mixerBitCrusher.gain(0, 1.0) ;
  mixerBitCrusher.gain(1, 0.0) ;
