...
int8_t harmonizer2MenuPos = 1 ;
int8_t harmonizer2MenuCase = 0 ;
...
void fourMenuControl() {
  switch(harmonizerMenuCase) {
    ...
    case 2:
      ...
      if (harmonizer2Cursor[0] > harmonizer2CursorMAX[0]) {
        harmonizer2Cursor[0] = 1 ;
      }
      if (harmonizer2Cursor[0] < 1) {
        harmonizer2Cursor[0] = harmonizer2CursorMAX[0] ;
      }
      if (harmonizer2Cursor[1] > harmonizer2CursorMAX[1]) {
        harmonizer2Cursor[1] = 1 ;
      }
      if (harmonizer2Cursor[1] < 1) {
        harmonizer2Cursor[1] = harmonizer2CursorMAX[1] ;
      } 
      while(harmonizer2Cursor[1] > (harmonizer2MenuPos+2)) {
        harmonizer2MenuPos ++ ;
      }
      while(harmonizer2Cursor[1] < harmonizer2MenuPos) {
        harmonizer2MenuPos -- ;
      }
...
void fourMenuPrint() {
  switch(harmonizerMenuCase) {
    ...
    case 2:
      ...
      display.drawRect(1+(harmonizer2Cursor[0]-1)*64, 17+(harmonizer2Cursor[1]-harmonizer2MenuPos)*16, 62, 13, WHITE) ;
    break;
    case 3:
      display.setCursor(4,4) ;
      display.setTextColor(WHITE) ;
