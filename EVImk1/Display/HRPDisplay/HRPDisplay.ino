...
const unsigned char logoBMP [] PROGMEM = {
  ...
  , 
  ...
  , 
...
int8_t menuCursor[13][9] = { {   1,   1,   1,   7,      1,      1,    1,    4,     1},    //main menu select
                             ...
                             {   1,   1,   1,   5,      1,      1,    1,    3,     1} } ; //midi settings select
...
int8_t midiSettingsMenuCase = 0 ;
int midiSettingsAddress = 0x65 ;
int8_t midiChannel = 0 ;
int16_t leadVelocity = 0 ;
int16_t chordVelocity = 0 ;
uint8_t midiSettingsRes = B00000000 ;
int8_t midiSettingsCC[] = {0, 0, 0} ; //{pressure, portamento, extra mod} 
int8_t midiSettingsBlinker = 0 ;
unsigned long midiSettingsTimer = 0 ;
...
Serial.begin(9600);
  ...
  display.drawBitmap(LOGO_X, LOGO_Y, logoBMP, LOGO_W, LOGO_H, WHITE) ;
  display.display();
  ...
  midiChannel = fram.read8(midiSettingsAddress) ;
  leadVelocity = fram.read8(midiSettingsAddress+1) ;
  chordVelocity = fram.read8(midiSettingsAddress+2) ;
  midiSettingsRes = fram.read8(midiSettingsAddress+3) ;
  midiSettingsCC[0] = fram.read8(midiSettingsAddress+4) ;
  midiSettingsCC[1] = fram.read8(midiSettingsAddress+5) ;
  midiSettingsCC[2] = fram.read8(midiSettingsAddress+6) ;
...
void transpositionMenuPrint() {
  ...
  switch(transpositionMenuCase) {
    case 0: {
      int8_t s = sizeOfInt(transpositionPosition) ;
...
void midiSettingMenuControl() {
  switch(midiSettingsMenuCase) {
    case 0:
      menuControl(MIDI_SETTINGS) ;
      if (backFunction && backFunctionToggle) {
        backFunctionToggle = false ;
        menuCase = 0 ;
      }
      if (selectFunction && selectFunctionToggle) {
        selectFunctionToggle = false ;
        midiSettingsMenuCase = menuCursor[MIDI_SETTINGS][YPOS] ;
      }
    break;
    case 1:
      midiSettingsBlinkerControl(0) ;
    break;
    case 2:
      midiSettingsBlinkerControl(1) ;     
    break;
    case 3:
      midiSettingsBlinkerControl(2) ;
    break;
    case 4:
      if (backFunction && backFunctionToggle) {
        backFunctionToggle = false ;
        midiSettingsMenuCase = 0 ;
      }
    break;
    case 5:
      if (backFunction && backFunctionToggle) {
...
void midiSettingMenuPrint() {
  if (midiSettingsMenuCase == 4) {
    display.setCursor(4,4) ;
    display.setTextColor(WHITE) ;
    display.setTextSize(1) ;   
    display.print("Midi") ;
    display.print(" ") ;
    display.print("Resolutions") ;
  } else if (midiSettingsMenuCase == 5) {
    display.setCursor(4,4) ;
    display.setTextColor(WHITE) ;
    display.setTextSize(1) ;   
    ...
    for (int i=0; i<4; i++) {
      switch(menuCursor[MIDI_SETTINGS][YSCROLL]+i) {
        case 1:
          ...
          display.setCursor((100-2*sizeOfInt(midiChannel)), (20+16*i)) ;
          display.setTextColor(WHITE) ;
          display.setTextSize(1) ;   
          display.print(midiChannel) ;

          if ((midiSettingsBlinker == 0) && (midiSettingsMenuCase == 1)) {
            display.fillRect(90, (20+16*i), 24, 9, BLACK) ;
          }
        break;
        case 2:
          display.setCursor(4,(20+16*i)) ;
          ...
          display.setCursor((100-2*sizeOfInt(leadVelocity)), (20+16*i)) ;
          display.setTextColor(WHITE) ;
          display.setTextSize(1) ;   
          display.print(leadVelocity) ;

          if ((midiSettingsBlinker == 0) && (midiSettingsMenuCase == 2)) {
            display.fillRect(90, (20+16*i), 24, 9, BLACK) ;
          }
        break;
        case 3:
          ...
          display.setCursor((100-2*sizeOfInt(chordVelocity)), (20+16*i)) ;
          display.setTextColor(WHITE) ;
          display.setTextSize(1) ;   
          display.print(chordVelocity) ;
  
          if ((midiSettingsBlinker == 0) && (midiSettingsMenuCase == 3)) {
            display.fillRect(90, (20+16*i), 24, 9, BLACK) ;
          }
        break;
        case 4:
    ...
    display.drawRect(1, (17+(menuCursor[MIDI_SETTINGS][YPOS]-menuCursor[MIDI_SETTINGS][YSCROLL])*16), 125, 13, WHITE) ;
...
void midiSettingsBlinkerControl(uint8_t type) {
  if ( ((millis() - midiSettingsTimer) >= 400) && (midiSettingsBlinker == 1) ) {
    midiSettingsBlinker = 0 ;
    midiSettingsTimer = millis() ;
    menuUpdate = true ;
  } else if ( ((millis() - midiSettingsTimer) >= 200) && (midiSettingsBlinker == 0) ) {
    midiSettingsBlinker = 1 ;
    midiSettingsTimer = millis() ;
    menuUpdate = true ;
  }
  ...
  if (selectFunction && selectFunctionToggle) {
    ...
    switch(type) {
      case 0:
        fram.write8(midiSettingsAddress, midiChannel) ;
      break;
      case 1:
        fram.write8(midiSettingsAddress+1, leadVelocity) ;
      break;
      case 2:
        fram.write8(midiSettingsAddress+2, chordVelocity) ;
      break;
    }
    midiSettingsBlinker = 0 ;
  }
  ...
  switch(type) {
    ...
    break;
    case 1:
      leadVelocity = constrain(leadVelocity, 0, 127) ;
    break;
    case 2:
      chordVelocity = constrain(chordVelocity, 0, 127) ;
    break;
  }
}
...
void midiResolutionControl() {
  
}

/**********************************************************************************************************************************************/

void midiResolutionPrint() {
